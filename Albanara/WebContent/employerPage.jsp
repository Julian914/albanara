				...
				<div class="col-md-4">
					<div class="employerInfo">
						<ul>
							...
							<li>전화번호 :</li>
							<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>${employer.employerNumber}</b>
							</li>
							<li>홈페이지:</li>
							<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
				...
				<c:forEach var="list" items="${nowRecruinmentList}"
					...
					<div id="accordion-contents">
						...
						<br> <input type="button" class="btn btn-light"
							...
							value="공고 상세 보기"> <input type="button"
							class="btn btn-secondary"
							onclick="location.href='../recruitment/updateRecruitmentForm.do?seq=${list.recruitmentSeq}'"
							value="수정"> <input type="button"
							class="btn btn-secondary"
							onclick="location.href='../recruitment/deleteRecruitmentAction.do?seq=${list.recruitmentSeq}'"
							value="삭제"> <br> <br>
									...
									<c:forEach var="hiredEmployeeList"
										...
										<div class="accordion-contents2 child">
											...
											<input type="button" class="btn btn-light"
												...
												value="채용자 상세 보기"> <input type="button"
												class="btn btn-primary"
