				...
				<c:forEach var="list" items="${recruitmentList}" varStatus="status">
					...
					<div id="accordion-contents">
						...
						<div class="accordion employeesList">
								...
								<c:if test="${status.index eq employeeListMap.key}">
									...
									<c:forEach var="employeeList"
										...
										<div class="accordion-contents2 child">
											...
											<input type="button" onclick="location.href='insertProposal.do?seq=${list.recruitmentSeq}&seq2=${employeeList.employeeSeq}'" 
												value="일자리 제안하기" >
											<input type="button" onclick="location.href='insertHiredHistory.do?seq=${list.recruitmentSeq}&seq2=${employeeList.employeeSeq}'" 
												value="채용하기" >
										</div>
									</c:forEach>
							...
							<c:forEach var="hiredEmployeeList" items="${hiredEmployeeListMap.employeeList}">
