...
public class RecruitmentService {
	...
	//진행중인 전체 공고목록
	public List<Recruitments> recruitmentList()throws Exception {
	...
	public List<Recruitments> totalRecruitmentListService(HttpServletRequest request) throws Exception {
